...
was `r summary_info$highest_renewable_energy_share`%. The country corresponding with this high share of renewable energy is the Democratic Republic of the Congo. In contrast to renewable energy sources, the country with the highest CO2 emissions as of 2018 was `r summary_info$highest_emissions_2018`. It is also important to look at countries with high CO2 emissions in terms of population. Our data showed that the country with the highest emission per capita was `r summary_info$highest_emissions_per_capita`. This means that this country produces more emissions per person than any other country in our data. 
